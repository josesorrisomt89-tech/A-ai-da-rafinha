export const MENU_DATA = {
  ...
  "users": [
    { "id": "user_admin", "name": "Admin", "password": "rafinha#2024", "isAdmin": true, "permissions": [] },
    { "id": "user_caixa", "name": "Caixa", "password": "caixa@123", "isAdmin": false, "permissions": ["access_pos"] },
    { "id": "user_cozinha", "name": "Cozinha", "password": "cozinha@123", "isAdmin": false, "permissions": ["access_kitchen"] }
  ],
  "deliveryZones": [
